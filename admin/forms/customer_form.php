<fieldset>
    ...
    <div class="form-group">
        <label for="phone">Phone</label>
            <input name="phone" value="<?php echo $edit ? $customer['phone'] : ''; ?>" placeholder="+880" class="form-control"  type="text" id="phone">
    </div> 

                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE == "customers.php" || CURRENT_PAGE == "add_customer.php") ? 'class="active"' : ''; ?>>
                                    <a href="#"><i class="fa fa-user-circle fa-fw"></i> Vendors & vehicles<span class="fa arrow"></span></a>
                                ...
                                <li>
                                    <a href="admin_users.php"><i class="fa fa-users fa-fw"></i> Admin's Checkout</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.sidebar-collapse -->

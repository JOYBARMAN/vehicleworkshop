...
class User
{
    ...
    // Register new users
    public function register($user_name, $user_email, $user_password, $phone_number)
    {
        try {
            // Hash password
            ...
            $sql = "INSERT INTO users(user_name, user_email, user_password, phone_number) VALUES(:user_name, :user_email, :user_password, :phone_number)";

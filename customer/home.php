  ...
  <nav class="navbar navbar-expand-lg fixed-top ">
	  ...
	  <div class="collapse navbar-collapse " id="navbarSupportedContent">
	    <ul class="navbar-nav mr-4">
		  ...
		  <li class="nav-item">
	        <a class="nav-link " data-value="logout"<a href="?logout=true">Log out</a>
	      </li>
		  <li>
		  <li class="nav-item">
			...
			<div class="col-md-4 col-lg-4 col-sm-12">
				<div class="card">
					...
					<div class="card-footer">
						<a href="http://localhost/vehicleWorkshop/customer/service_request/index.php" class="card-link">submit description</a>
					</div>
				</div>
			</div>
			<div class="col-md-4 col-lg-4 col-sm-12">
